...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.w600, color: TColors.dark),
    titleMedium: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w500, color: TColors.dark),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w300, color: TColors.darkGrey),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.w600, color: TColors.light),
    titleMedium: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w500, color: TColors.light),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w300, color: TColors.lightGrey),
